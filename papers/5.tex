Is Surrogacy a Special Kind of Labour That Should Not Be Treated
According to Market Norms? 2 Abstract This paper examines whether
...
sustaining gender inequality in our society. Introduction 3 Surrogacy is
...
surrogacy typically centres on the potential exploitation of surrogates
...
governing commercial exchanges. The view that there is something special
...
and should be treated distinctly to other forms of labour. 4 I argue
...
be treated according to market norms. 1.1: Anderson's Case Against
Commercial Surrogacy Commercial surrogacy involves a prospective
...
another is a service 5 that would be wrong to sell or buy, and contract
pregnancy wrongfully allows for the extension of the market into the
``private'' sphere of reproduction. Her argument for this claim begins
...
of these in three ways: (Anderson 1990, 81): i) Surrogates are alienated
as they are required to suppress their emotional connection with the
child. ii) Surrogates are degraded as the legitimacy of their personal
evolving perspective on their own pregnancy is denied, or is demoted to
an amount of money. iii) Surrogates are exploited as their emotional
needs are not considered as relevant, yet may also be manipulated to
encourage them to undergo surrogacy. 6 These three ways of denying
...
welcome new life (Ibid, 81). Without regard for this crucial emotional
...
rather than a person worthy of respect. For Anderson, commercial
...
fluctuations in a product's price (Ibid, 84). This is degrading, since
an instinctive human emotion is not taken into account, and so in some
way also denies the 7 humanity of the surrogate, reducing her to a
vessel whose sole function is to produce children. The emotional ties
which she may establish with the child are ignored. In light of
...
surrogate's labour and personal needs into account. 8 1.2: Objections
from Fabre Fabre (2006) argues that Anderson is wrong to conclude that
...
we 9 should assume they have autonomy to willingly choose to be
surrogates (ibid, 212). We do not think twice about men who willingly
...
themselves, and we should do the same for surrogates. Regarding fair
...
1.3: Responses to Fabre I can imagine a response from Anderson in
...
experience of creating life within one's body. Relinquishing a child one
10 has carried to term can lead to extreme emotional challenges that
...
unnatural according to Anderson (1990, 81-82). However, I argue Anderson
...
emotional harm. While I do agree that there is nothing essentially wrong
with surrogacy, I also maintain that there is something that makes us
feel uneasy about commercialising women's 11 bodily functions, a point
...
there is something that indeed does set surrogacy apart. 2: Debra Satz's
Asymmetry Thesis I argue that this intuition can be answered by Satz
...
not be commercialised. Satz rejects Anderson's claims that surrogacy is
...
in the background (Ibid, 124). My focus will be on two of Satz's
...
12 Satz asserts that there is nothing essentially, or morally wrong with
...
and body (Ibid, 124). She points to the difference between surrogacy and
...
this, surrogacy entails selling control over one's body (Ibid, 125). To
...
underlined by something different. This difference is the type of
...
historically (ibid, 125). Underlying gender inequality is not similarly
...
does not have to do with their sex - anyone can be 13 an athlete. Not
...
for the purpose of child rearing (Ibid, 127). The purpose of working as
...
(Ibid, 127). 3.1: Objections to Satz I can imagine one pointing out that
...
cannot make 14 any choices for themselves and are completely helpless at
...
they value. I also want to highlight multiple other labours that could
...
is argued to be objectionable. 15 3.2: A Defence of Satz I argue that
...
surrogacy here to be problematic. I believe that the same arguments used
...
of 16 women as a whole. Even if we assume that some women do find
...
version of the asymmetry thesis. Regarding the second critique, I argue
...
surrogacy is defined by and tied to being female entirely, as child
-rearing is exclusive to biological women. The male sex cannot
participate in this line of work at all, and so it is a requirement that
the workers are biological women, able to reproduce. 17 While we could
...
asymmetry thesis holds. Regarding the status of women's reproductive
...
reason to reject permitting commercial surrogacy. Conclusion Surrogacy
...
turn reinforces gendered stereotypes which 18 reduce women to their
...
society. 4415 words excluding title, abstract, and bibliography
Bibliography 19 Anderson, E. S. (1990). Is Women's Labor a Commodity?.
Philosophy \& Public Affairs, 71- 92.13. Fabre, C. (2006). Surrogacy
Contracts. In Whose Body is it Anyway? Justice and the Integrity of the
Person. Oxford University Press. MacKinnon, C. A, and Dworkin, A.
(1988). Pornography and Civil Rights: A New Day for Women's Equality.
Minneapolis, MN: Organizing Against Pornography. MacKinnon, C. A.
(1989). Towards a Feminist Theory of the State. Harvard University
Press. Satz, D. (1992). Markets in women's reproductive labor.
Philosophy \& Public Affairs, 107- 131.14. UN Women. (2025). FAQs: What
